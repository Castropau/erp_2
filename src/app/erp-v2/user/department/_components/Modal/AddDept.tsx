"use client";
import { AddDepartments, CreateDepartment } from "@/api/depts/createDepartment";
// import { AddDepartment, CreateDepartment } from "@/api/depts/createDepartment";
...
const AddDept = () => {
  ...
  const {
    ...
    mutationFn: (data: AddDepartments) => CreateDepartment(data),
    onSuccess: () => {
