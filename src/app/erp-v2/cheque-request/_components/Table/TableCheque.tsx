              ...
              >
                ...
                <td className="text-xs flex gap-2 text-center justify-center py-1 px-4">
                  <button
                    ...
                    className="hover:cursor-pointer hover:underline  flex items-center gap-2   text-blue-800 border-none px-4 py-2   transition duration-200 uppercase"
                  ...
                  <button
                    ...
                    className=" flex items-center gap-1 hover:underline hover:cursor-pointer  text-red-700 px-3 py-1.5   transition duration-200 uppercase"
                  >
                    Delete
                  </button>
                </td>
